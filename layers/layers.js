...
lyr_not_inspected_2.set('fieldLabels', {'fid': 'no label', 'FACILITY_ID': 'no label', 'FACILITY_NAME': 'inline label - visible with data', 'RECORD_ID': 'no label', 'PROGRAM_NAME': 'inline label - visible with data', 'PROGRAM_ELEMENT': 'no label', 'PE_DESCRIPTION': 'inline label - visible with data', 'FACILITY_ADDRESS': 'inline label - visible with data', 'FACILITY_CITY': 'no label', 'FACILITY__STATE': 'no label', 'FACILITY_ZIP': 'no label', 'FACILITY_LATITUDE': 'no label', 'FACILITY_LONGITUDE': 'no label', 'OWNER_ID': 'no label', 'OWNER_NAME': 'no label', 'OWNER_ADDRESS': 'no label', 'OWNER_CITY': 'no label', 'OWNER_STATE': 'no label', 'OWNER_ZIP': 'no label', 'ObjectId': 'no label', });
